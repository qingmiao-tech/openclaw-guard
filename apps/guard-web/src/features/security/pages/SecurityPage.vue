...
import { resolveRuntimeUrl } from '@/services/runtime';
import {
...
const hardeningScriptUrl = computed(() => resolveRuntimeUrl(`/api/harden/script?platform=${hardeningPlatform.value}`));
...
<template>
  <div class="page-stack">
    <header class="page-header">
      <div>
        <p class="page-header__eyebrow">{{ ui.label('安全 / 防护', 'Security / Protection') }}</p>
      ...
      <template v-else-if="hardeningResource.data">
        ...
        <PageCard :title="ui.label('主机加固指南（Beta）', 'Host hardening guide (Beta)')" eyebrow="Hardening">
          ...
          <div class="pill-row">
            ...
            <a class="inline-link" :href="hardeningScriptUrl">
