...
课程采用模块化设计，包含 **12 天核心必修模块**、**2 个进阶选修模块** 和 **5 个选修渠道 Lab**，总学习时长可灵活扩展至 15 天。学员可根据自身需求选择学习路径，既适合从头到尾系统学习，也支持按需跳选特定模块。
...
- **全栈路径**（约 33 小时）：Day 1-14 + 全部渠道 Lab
...
> **时长汇总**：12 天核心必修模块共计约 **21.5 小时**；2 个进阶选修模块约 **5 小时**；5 个选修渠道 Lab 共计约 **6.5 小时**；全部完成约 **33 小时**。
