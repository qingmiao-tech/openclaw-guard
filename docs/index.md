...
如果你第一次接触 OpenClaw，不想一上来就看到 Git、Cron、OAuth、插件机制这些概念，那么 Guard 首页会先只讲最核心的 4 条主路径：
...
- [快速开始](/getting-started)：从安装到第一次进入工作台
- [使用场景](/showcase)：看清它适合什么团队和机器环境
...
- [版本与发布](/releases)：版本线、安装方式与 GitHub Pages 文档发布
